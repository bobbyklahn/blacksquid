...
const st = {
  ...
  h: { fontFamily: 'var(--display)', fontWeight: 540, fontSize: '1.4rem', marginBottom: 10, color: 'var(--trade-ink)' },
  ...
  p: { fontFamily: 'var(--mono)', color: 'var(--trade-muted)', fontSize: '0.72rem' },
  qty: { width: 64, padding: '6px 8px', fontFamily: 'var(--mono)', fontSize: '0.82rem', textAlign: 'center' },
  rm: { background: 'none', border: 'none', color: 'var(--trade-muted)', fontSize: '0.8rem' },
  lab: { fontFamily: 'var(--mono)', fontSize: '0.62rem', letterSpacing: '0.16em', textTransform: 'uppercase', color: 'var(--trade-muted)', display: 'block', margin: '14px 0 5px' },
  clear: { width: '100%', marginTop: 8, padding: 6, background: 'none', border: 'none', color: 'var(--trade-muted)', fontFamily: 'var(--mono)', fontSize: '0.66rem', textDecoration: 'underline' },
  fine: { fontFamily: 'var(--mono)', color: 'var(--trade-muted)', fontSize: '0.66rem', lineHeight: 1.7, marginTop: 16 },
};
